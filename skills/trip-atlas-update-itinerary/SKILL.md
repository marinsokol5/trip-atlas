...
- `occasions` (optional) lists what makes the date itself special, shown in full under the day title: "🎂 Ana's birthday", "Christmas Eve", "Last night in Japan". Not for plans; those are activities.
